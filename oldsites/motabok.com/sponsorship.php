...
#content_area_sub {
	width: 777px;
	height: 680px;
	background-image: url(images/bkg_sub.png);
}
-->
</style>
...
<div id="main_menu">
        ...
        <div id="content_heading_sponsorship"></div>
            ...
            <div id="content_areaM_sub">
            	<div id="content_areaM_L_sub">
                    	<div id="mainpage_text">
                    	  <p>Parties interested in sponsoring the concert can contact Donors &amp; Sponsorship Coordinator Thad Balkman or Event Coordinator Joshua Peters.<br />
                    	    <br />
                    	      <br />
                   	        Thad Balkman <br />
                   	        <a href="mailto:thad@balkman.com">thad@balkman.com</a><br />
                    	      <br />
                   	        <br />
                    	    Joshua Peters <br />
(405) 625-1273 <br />
<a href="mailto:jcpeters22@gmail.com">jcpeters22@gmail.com</a><br />
                    	  </p>
